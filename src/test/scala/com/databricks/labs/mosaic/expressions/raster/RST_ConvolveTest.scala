...
class RST_ConvolveTest extends QueryTest with SharedSparkSessionGDAL with RST_ConvolveBehaviors {
    ...
    test("Testing RST_Convolve with manual GDAL registration (H3, JTS).") {
        noCodegen {
