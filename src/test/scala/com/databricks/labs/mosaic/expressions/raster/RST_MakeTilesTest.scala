...
class RST_MakeTilesTest extends QueryTest with SharedSparkSessionGDAL with RST_MakeTilesBehaviors {
    ...
    test("Testing RST_MakeTiles with manual GDAL registration (H3, JTS).") {
        noCodegen {
