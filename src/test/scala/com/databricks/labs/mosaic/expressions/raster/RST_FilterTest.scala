...
class RST_FilterTest extends QueryTest with SharedSparkSessionGDAL with RST_FilterBehaviors {
    ...
    test("Testing RST_Filter with manual GDAL registration (H3, JTS).") {
        noCodegen {
