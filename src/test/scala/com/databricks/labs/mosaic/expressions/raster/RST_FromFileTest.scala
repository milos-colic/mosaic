...
class RST_FromFileTest extends QueryTest with SharedSparkSessionGDAL with RST_FromFileBehaviors {
    ...
    test("Testing RST_FromFile with manual GDAL registration (H3, JTS).") {
        noCodegen {
