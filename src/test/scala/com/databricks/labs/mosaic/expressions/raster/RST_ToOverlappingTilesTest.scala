...
class RST_ToOverlappingTilesTest extends QueryTest with SharedSparkSessionGDAL with RST_ToOverlappingTilesBehaviors {
    ...
    test("Testing RST_ToOverlappingTilesTest with manual GDAL registration (H3, JTS).") {
        noCodegen {
