...
class RST_InitNoDataTest extends QueryTest with SharedSparkSessionGDAL with RST_InitNoDataBehaviors {
    ...
    test("Testing RST_InitNoData with manual GDAL registration (H3, JTS).") {
        noCodegen {
