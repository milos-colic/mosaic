...
class RST_MergeAggTest extends QueryTest with SharedSparkSessionGDAL with RST_MergeAggBehaviors {
    ...
    test("Testing RST_MergeAgg with manual GDAL registration (H3, JTS).") {
        noCodegen {
