...
class RST_CombineAvgTest extends QueryTest with SharedSparkSessionGDAL with RST_CombineAvgBehaviors {
    ...
    test("Testing RST_CombineAvg with manual GDAL registration (H3, JTS).") {
        noCodegen {
