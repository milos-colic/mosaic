...
class RST_MapAlgebraTest extends QueryTest with SharedSparkSessionGDAL with RST_MapAlgebraBehaviors {
    ...
    test("Testing RST_MapAlgebra with manual GDAL registration (H3, JTS).") {
        noCodegen {
