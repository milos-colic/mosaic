...
class RST_BoundingBoxTest extends QueryTest with SharedSparkSessionGDAL with RST_BoundingBoxBehaviors {
    ...
    test("Testing RST_BoundingBox with manual GDAL registration (H3, JTS).") {
        noCodegen {
