...
class RST_DerivedBandAggTest extends QueryTest with SharedSparkSessionGDAL with RST_DerivedBandAggBehaviors {
    ...
    test("Testing RST_DerivedBandAggTest with manual GDAL registration (H3, JTS).") {
        noCodegen {
