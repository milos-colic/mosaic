...
class RST_FromContentTest extends QueryTest with SharedSparkSessionGDAL with RST_FromContentBehaviors {
    ...
    test("Testing RST_FromContent with manual GDAL registration (H3, JTS).") {
        noCodegen {
