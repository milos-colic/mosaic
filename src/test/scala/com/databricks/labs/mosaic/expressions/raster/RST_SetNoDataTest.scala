...
class RST_SetNoDataTest extends QueryTest with SharedSparkSessionGDAL with RST_SetNoDataBehaviors {
    ...
    test("Testing RST_SetNoData with manual GDAL registration (H3, JTS).") {
        noCodegen {
