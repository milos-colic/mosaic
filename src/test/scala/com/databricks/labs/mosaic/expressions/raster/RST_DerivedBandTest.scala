...
class RST_DerivedBandTest extends QueryTest with SharedSparkSessionGDAL with RST_DerivedBandBehaviors {
    ...
    test("Testing RST_DerivedBandTest with manual GDAL registration (H3, JTS).") {
        noCodegen {
