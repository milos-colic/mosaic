...
class RST_CombineAvgAggTest extends QueryTest with SharedSparkSessionGDAL with RST_CombineAvgAggBehaviors {
    ...
    test("Testing RST_CombineAvgAgg with manual GDAL registration (H3, JTS).") {
        noCodegen {
