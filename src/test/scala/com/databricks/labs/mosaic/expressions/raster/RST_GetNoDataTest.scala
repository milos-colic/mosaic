...
class RST_GetNoDataTest extends QueryTest with SharedSparkSessionGDAL with RST_GetNoDataBehaviors {
    ...
    test("Testing RST_GetNoData with manual GDAL registration (H3, JTS).") {
        noCodegen {
