...
class RST_FromBandsTest extends QueryTest with SharedSparkSessionGDAL with RST_FromBandsBehaviors {
    ...
    test("Testing RST_FromBands with manual GDAL registration (H3, JTS).") {
        noCodegen {
