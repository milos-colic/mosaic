...
case class GeometryKLoopExplode(geom: Expression, resolution: Expression, k: Expression, indexSystem: IndexSystem)
    ...
    override def eval(input: InternalRow): TraversableOnce[InternalRow] = {
        ...
        if (geometryRaw == null || resolutionRaw == null || kRaw == null) {
            ...
            val kLoop = Mosaic.geometryKLoop(geometryVal, resolutionVal, kVal, indexSystem)
